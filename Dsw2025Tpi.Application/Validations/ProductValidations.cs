...
{
    public static void ValidateProduct(ProductModel.Request request)
    {
    ...
    public async static void ValidateAddedProduct(ProductModel.Request request, IRepository _repository)
    {
